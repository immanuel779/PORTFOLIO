...
export default function Projects() {
  ...
  return (
    <SectionWrapper id="projects" className="pt-32">
      <SectionHeading title="Featured Projects" subtitle="A selection of my recent work and what I can build for you" />
      
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {loading ? (
          <div className="col-span-full text-center py-20"><p className="text-2xl font-semibold text-dark-500">Loading projects...</p></div>
        ) : projects.length === 0 ? (
          <div className="col-span-full text-center py-20"><p className="text-2xl font-semibold text-dark-500">No projects added yet. Check back soon!</p></div>
        ) : (
