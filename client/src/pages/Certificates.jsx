  ...
  return (
    <SectionWrapper id="certificates" className="pt-32">
      <SectionHeading 
        ...
        subtitle="Professional certifications and courses I have completed to enhance my skills" 
      />
              ...
              <div className="p-6 flex-1 flex flex-col">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="flex items-center text-sm text-dark-500 dark:text-dark-400">
                    <Calendar className="w-4 h-4 mr-1" /> {cert.year}
                  </span>
                </div>
                ...
                <p className="text-dark-600 dark:text-dark-300 mb-4">
                  Issued by <span className="font-semibold text-primary-500">{cert.issuer}</span>
                </p>
                ...
                {cert.link && (
                  <a 
                    ...
                    className="mt-auto inline-flex items-center text-sm font-medium text-primary-500 hover:underline"
                  >
