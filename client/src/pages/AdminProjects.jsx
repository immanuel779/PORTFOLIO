...
export default function AdminProjects() {
  ...
  const [formData, setFormData] = useState({ title: '', description: '', category: '', technologies: '', githubUrl: '', liveUrl: '' });
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        <div className="bg-white dark:bg-dark-800 p-6 rounded-2xl shadow-soft">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {imageUrl && <img src={imageUrl} alt="Preview" className="w-full h-32 object-cover rounded-lg shadow-soft" />}
