...
export default function Experience() {
  ...
  useEffect(() => {
    // ✅ FIXED: Uses your live backend URL from Vercel
  ...
  return (
    <SectionWrapper id="experience" className="pt-32">
      <SectionHeading title="My Professional Journey" subtitle="A timeline of growth, leadership, and delivering exceptional results" />
      ...
      <div className="relative border-l-2 border-primary-500/30 ml-4 md:ml-6">
        {experiences.length === 0 ? (
          ...
          experiences.map((exp, index) => (
            <motion.div key={exp.id} initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.5, delay: index * 0.1 }} className="mb-12 ml-8 relative">
